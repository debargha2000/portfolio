...
import { CharReveal, WordReveal, Magnetic } from "../components/motion/Motion";

import { processData } from "../data/processData";
import type { Movement as MovementT, Engagement, FAQ } from "../data/types";

import { Movement, PricingCard, FAQItem } from "../components/process/ProcessComponents";
  ...
  return (
    <main id="main" tabIndex={-1} className="pt-32 md:pt-40 pb-20 px-6 md:px-10">
      <div className="mb-20 md:mb-32">
        ...
        <div className="mt-8">
          <WordReveal
            className="font-display text-2xl md:text-4xl leading-tight max-w-4xl text-[var(--bone)]/80"
            as="p"
          >
            Not a waterfall. Not an agile sprint theatre. A deliberate pace that respects the work
            and the people it's for.
          </WordReveal>
        </div>
      </div>
      ...
      <section>
        {movements.map((m: MovementT, i: number) => (
      ...
      <section className="py-20 md:py-32 border-t border-[var(--bone)]/15">
        ...
        <WordReveal className="mt-10 text-sm text-[var(--bone)]/60 max-w-2xl" as="p">
          All pricing is indicative and subject to scope. We publish our rates because we believe
          opacity is a tax paid by the people who can least afford it.
        </WordReveal>
      </section>
      ...
      <section className="py-20 md:py-28 text-center border-t border-[var(--bone)]/15">
        ...
        <Magnetic>
          <Link to="/contact" className="chip shine glow-pulse">
            Start a project ↗
          </Link>
        </Magnetic>
      </section>
