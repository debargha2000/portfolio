import{r as e}from"./rolldown-runtime-QTnfLwEv.js";import{f as t,h as n,n as r,p as i,t as a}from"./@react-three-CKMXv1xh.js";var o=e(n(),1),s=`
  varying vec2 vUv;
  void main() {
    vUv = uv;
...
`,l=i(),u=()=>{let e=(0,o.useRef)(null),n=(0,o.useMemo)(()=>({uTime:{value:0},uResolution:{value:new t(window.innerWidth,window.innerHeight)}}),[]);return r(t=>{e.current&&(e.current.uniforms.uTime.value=t.clock.elapsedTime,e.current.uniforms.uResolution.value.set(window.innerWidth,window.innerHeight))}),(0,l.jsxs)(`mesh`,{children:[(0,l.jsx)(`planeGeometry`,{args:[2,2]}),(0,l.jsx)(`shaderMaterial`,{ref:e,vertexShader:s,fragmentShader:c,uniforms:n,transparent:!0,depthWrite:!1})]})};function d(){let e=(0,o.useRef)(null),[t,n]=(0,o.useState)(!0);return(0,o.useEffect)(()=>{if(!e.current)return;let t=new IntersectionObserver(([e])=>{n(e.isIntersecting)},{rootMargin:`0px`});return t.observe(e.current),()=>t.disconnect()},[]),(0,l.jsx)(`div`,{ref:e,className:`h-full w-full`,children:(0,l.jsx)(a,{camera:{position:[0,0,1]},dpr:[1,window.devicePixelRatio||2],gl:{antialias:!1,powerPreference:`high-performance`,alpha:!1},frameloop:t?`always`:`demand`,children:(0,l.jsx)(u,{})})})}export{d as InkCanvas};